const apiPrefix = 'https://desonode.rylees.net/api/v0/'
const webAppPrefix = 'https://desonode.rylees.net'
...
export const avatarUrlPKOnly = (ProfileKey) => {

    if(ProfileKey){
        let avatarImage = `${apiPrefix}get-single-profile-picture/${ProfileKey}?fallback=${webAppPrefix}/assets/img/default_profile_pic.png`
...
export async function updateProfile(derivedKey, derivedSeed) {
    /* let {
        UpdaterPublicKeyBase58Check, 
        ParentStakeID = '', 
        RepostedPostHashHex = '',
  ...
  const data = {
      "UpdaterPublicKeyBase58Check": 'BC1YLiyYgAp93FJnaK6HwViR99APU8QTE9UDGwHfPUXPn59ZyaQfPEj',
      "ProfilePublicKeyBase58Check": PostHashHexToModify,
      "NewUsername": ParentStakeID,
      "NewDescription": "",
      "NewProfilePic": RepostedPostHashHex,
      "NewCreatorBasisPoints": PostExtraData,
      "NewStakeMultipleBasisPoints": "",
      "ExtraData": [],
      "MinFeeRateNanosPerKB": 5000,
      "TransactionFees": []           
  }
