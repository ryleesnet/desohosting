 ...
 handleClickOutside);
  ...
  return (
    <div
      ...
      id="popup-container"
      className={`popup ${isConfirmedVisible ? 'show' : ''} bg-slate-900/80 fixed z-20 top-1/2 right-1/2 -translate-x-[-50%] translate-y-[-50%] p-4 border flex-col items-center bg-slate-800 rounded-xl w-[26em] `} 
    >
